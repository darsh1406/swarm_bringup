...
def generate_launch_description():
    ...
    params_file = os.path.join(swarm_pkg, 'config', 'nav2_robot2_params.yaml')
    ...
    return LaunchDescription([
        GroupAction([
            ...
            Node(package='swarm_bringup', executable='odom_to_tf', name='odom_to_tf',
                parameters=[{'robot_name': 'robot2', 'spawn_x': 1.0, 'spawn_y': 1.0}], output='screen'),
            Node(package='tf2_ros', executable='static_transform_publisher', name='base_footprint_to_base_link',
                arguments=['0', '0', '0.010', '0', '0', '0', 'robot2/base_footprint', 'robot2/base_link'], output='screen'),
            Node(package='tf2_ros', executable='static_transform_publisher', name='base_link_to_base_scan',
                arguments=['-0.064', '0', '0.121', '0', '0', '0', 'robot2/base_link', 'robot2/base_scan'], output='screen'),
            ...
            Node(package='nav2_controller', executable='controller_server', name='controller_server',
                ...
                remappings=[('cmd_vel', '/robot2/cmd_vel')], output='screen'),
            ...
            Node(package='nav2_bt_navigator', executable='bt_navigator', name='bt_navigator',
                parameters=[params_file, {'robot_base_frame': base_frame, 'global_frame': 'map', 'odom_topic': '/robot2/odom'}], output='screen'),
            ...
            Node(package='nav2_velocity_smoother', executable='velocity_smoother', name='velocity_smoother',
                ...
                remappings=[('cmd_vel', '/robot2/cmd_vel_smoothed'), ('cmd_vel_smoothed', '/robot2/cmd_vel')], output='screen'),
