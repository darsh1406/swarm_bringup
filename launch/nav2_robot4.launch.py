    ...
    return LaunchDescription([
        GroupAction([
            ...
            Node(package='nav2_controller', executable='controller_server', name='controller_server',
                ...
                remappings=[('cmd_vel', '/robot4/cmd_vel')], output='screen'),
            ...
            Node(package='nav2_bt_navigator', executable='bt_navigator', name='bt_navigator',
                parameters=[params_file, {'robot_base_frame': base_frame, 'global_frame': 'map', 'odom_topic': '/robot4/odom'}], output='screen'),
            ...
            Node(package='nav2_velocity_smoother', executable='velocity_smoother', name='velocity_smoother',
                ...
                remappings=[('cmd_vel', '/robot4/cmd_vel_smoothed'), ('cmd_vel_smoothed', '/robot4/cmd_vel')], output='screen'),
